...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get privacyPolicyBody =>
      'ประกาศความเป็นส่วนตัวของ MKR\n\nโดยค่าเริ่มต้น MKR จัดเก็บการตั้งค่าของคุณ — ธีม ภาษา รายการติดตาม การแจ้งเตือน และรายการพอร์ตโฟลิโอ — ไว้ในเครื่องของคุณ ไม่จำเป็นต้องมีบัญชีเพื่อใช้ฟีเจอร์หลักของแอป คุณสามารถใช้งานแบบไม่ลงชื่อเข้าใช้ (guest) ได้ตลอดเวลา\n\nหากคุณเลือกสร้างบัญชี (อีเมลและรหัสผ่าน) อีเมลของคุณและข้อมูลการแจ้งเตือน/รายการติดตามจะถูกจัดเก็บโดยผู้ให้บริการระบบหลังบ้านของเรา (Supabase) เพื่อซิงค์ข้อมูลข้ามอุปกรณ์ หากคุณอนุญาตการแจ้งเตือน อุปกรณ์ของคุณจะลงทะเบียน push token กับ Firebase Cloud Messaging เพื่อให้ MKR ส่งการแจ้งเตือนราคาและปฏิทินเศรษฐกิจมายังอุปกรณ์นี้ได้ โดย token นี้ระบุอุปกรณ์ ไม่ใช่ตัวตนของคุณ\n\nMKR ไม่ต้องการข้อมูลการชำระเงินสำหรับฟีเจอร์ใดๆ ที่มีอยู่ในเวอร์ชันนี้ นโยบายความเป็นส่วนตัวฉบับเต็มที่เผยแพร่บนเว็บจะถูกจัดทำก่อนเปิดให้ใช้งานแอปต่อสาธารณะ ครอบคลุมการใช้ข้อมูลเพิ่มเติมใดๆ ที่อาจเกิดขึ้นหลังจากประกาศนี้';
